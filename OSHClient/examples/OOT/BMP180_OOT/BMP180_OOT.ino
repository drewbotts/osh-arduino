...
static const char BPRES_URI[] PROGMEM = "https://mmisw.org/ont/cf/parameter/air_pressure";
static const char TEMP_URI[] PROGMEM = "https://mmisw.org/ont/cf/parameter/air_temperature";
...
void setup() {
  ...
  s1.setLabel("Evironmental Observations");
  s1.addTimeStampUTC();
...
void loop(void) {
  if (timeStatus() != timeNotSet) {
    ...
    sos1->pushFloat(bmp.pressureToAltitude(seaLevelPressure,event.pressure));
